...
interface ZkSyncRegenesisTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getAdditionalZkSync()": FunctionFragment;
    ...
    "getStoredBlockHash()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getAdditionalZkSync",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getStoredBlockHash",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class ZkSyncRegenesisTest extends Contract {
  ...
  interface: ZkSyncRegenesisTestInterface;
  ...
  functions: {
    ...
    getAdditionalZkSync(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
    ...
    getStoredBlockHash(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  getAdditionalZkSync(overrides?: CallOverrides): Promise<string>;
  ...
  getStoredBlockHash(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    getAdditionalZkSync(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    getStoredBlockHash(overrides?: CallOverrides): Promise<BigNumber>;
