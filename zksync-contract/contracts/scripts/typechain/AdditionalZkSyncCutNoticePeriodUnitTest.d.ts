...
interface AdditionalZkSyncCutNoticePeriodUnitTestInterface
  ...
  functions: {
    ...
    "enableUpgradeFromScratch()": FunctionFragment;
    "exodusMode()": FunctionFragment;
    "firstPriorityRequestId()": FunctionFragment;
    "getApprovedUpgradeNoticePeriod()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "enableUpgradeFromScratch",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getApprovedUpgradeNoticePeriod",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class AdditionalZkSyncCutNoticePeriodUnitTest extends Contract {
  ...
  functions: {
    ...
    disableUpgrade(overrides?: Overrides): Promise<ContractTransaction>;

    "disableUpgrade()"(overrides?: Overrides): Promise<ContractTransaction>;

    enableUpgradeFromScratch(
      overrides?: Overrides
    ): Promise<ContractTransaction>;
    ...
    getApprovedUpgradeNoticePeriod(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
  ...
  enableUpgradeFromScratch(overrides?: Overrides): Promise<ContractTransaction>;
  ...
  getApprovedUpgradeNoticePeriod(overrides?: CallOverrides): Promise<BigNumber>;

  "getApprovedUpgradeNoticePeriod()"(
    overrides?: CallOverrides
  ): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    enableUpgradeFromScratch(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    disableUpgrade(overrides?: Overrides): Promise<BigNumber>;

    "disableUpgrade()"(overrides?: Overrides): Promise<BigNumber>;

    enableUpgradeFromScratch(overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    disableUpgrade(overrides?: Overrides): Promise<PopulatedTransaction>;
