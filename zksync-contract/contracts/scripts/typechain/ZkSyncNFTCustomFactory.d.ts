...
interface ZkSyncNFTCustomFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "registerNFTFactory(uint32,address,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "registerNFTFactory",
...
export class ZkSyncNFTCustomFactory extends Contract {
  ...
  interface: ZkSyncNFTCustomFactoryInterface;
  ...
  functions: {
    ...
    "registerNFTFactory(uint32,address,bytes)"(
      _creatorAccountId: BigNumberish,
      _creatorAddress: string,
      _signature: BytesLike,
      overrides?: Overrides
