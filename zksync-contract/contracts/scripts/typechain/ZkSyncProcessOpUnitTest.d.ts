...
interface ZkSyncProcessOpUnitTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getAuthFact(address,uint32)": FunctionFragment;
    ...
    "getTotalCommittedPriorityRequests()": FunctionFragment;
    "getTotalOpenPriorityRequests()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getTotalCommittedPriorityRequests",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getTotalOpenPriorityRequests",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class ZkSyncProcessOpUnitTest extends Contract {
  ...
  functions: {
    ...
    "collectOnchainOpsExternal((bytes32,bytes,uint256,tuple[],uint32,uint32),bytes32,uint64,bytes)"(
      _newBlockData: {
        newStateHash: BytesLike;
        publicData: BytesLike;
        timestamp: BigNumberish;
    ...
    getTotalCommittedPriorityRequests(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
    ...
    getTotalOpenPriorityRequests(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
  ...
  getTotalCommittedPriorityRequests(
    overrides?: CallOverrides
  ): Promise<BigNumber>;
  ...
  getTotalOpenPriorityRequests(overrides?: CallOverrides): Promise<BigNumber>;

  "getTotalOpenPriorityRequests()"(
    overrides?: CallOverrides
  ): Promise<BigNumber>;
