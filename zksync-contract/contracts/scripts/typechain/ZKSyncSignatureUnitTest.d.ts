...
interface ZKSyncSignatureUnitTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "changePubkeySignatureCheckCREATE2(tuple,bytes)": FunctionFragment;
    "changePubkeySignatureCheckECRECOVER(tuple,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "changePubkeySignatureCheckCREATE2",
    values: [
      {
  ...
  encodeFunctionData(
    functionFragment: "changePubkeySignatureCheckECRECOVER",
    values: [
      {
        accountId: BigNumberish;
        pubKeyHash: BytesLike;
...
export class ZKSyncSignatureUnitTest extends Contract {
  ...
  interface: ZKSyncSignatureUnitTestInterface;
  ...
  functions: {
    ...
    changePubkeySignatureCheckCREATE2(
      _changePk: {
        accountId: BigNumberish;
        pubKeyHash: BytesLike;
        owner: string;
    ...
    "changePubkeySignatureCheckCREATE2((uint32,bytes20,address,uint32),bytes)"(
      _changePk: {
        accountId: BigNumberish;
        pubKeyHash: BytesLike;
        owner: string;
    ...
    changePubkeySignatureCheckECRECOVER(
      _changePk: {
        accountId: BigNumberish;
        pubKeyHash: BytesLike;
        owner: string;
    ...
    "changePubkeySignatureCheckECRECOVER((uint32,bytes20,address,uint32),bytes)"(
      _changePk: {
        accountId: BigNumberish;
        pubKeyHash: BytesLike;
        owner: string;
