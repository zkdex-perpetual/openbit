...
interface MintableERC20FeeAndPayoutTestInterface
...
export class MintableERC20FeeAndPayoutTest extends Contract {
  ...
  functions: {
    ...
    payoutAmount(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
