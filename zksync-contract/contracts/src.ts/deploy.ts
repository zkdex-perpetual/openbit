...
//     public async deployTIA(ethTxOptions?: ethers.providers.TransactionRequest){
//         const { tx, address } = await this.deployViaCreate2(this.contracts.zkSync.bytecode, {
//             gasLimit: 12000000,
//             ...ethTxOptions
//         });
//         const zksRec = await tx.wait();
//
// //       const TIAContract = await deployContract(
// //             this.deployWallet,
// //             this.contracts.TIA.bytecode,
// //             [],
// //             {
// //                 gasLimit: 8000000,
// //                 ...ethTxOptions
// //             }
// //       );
// //       const TIArec = await TIAContract.deployTransaction.wait();
//       console.log(`TIA_ADDRESS=${address}`);
//     }
